...
def test_in_yard_respects_geofence() -> None:
    poly = [(1.0, 1.0), (5.0, 1.0), (5.0, 5.0), (1.0, 5.0)]
    assert in_yard(Pose(3.0, 3.0, 0.0), 8.0, 8.0, 0.2, geofence=poly)
    assert not in_yard(Pose(6.0, 3.0, 0.0), 8.0, 8.0, 0.2, geofence=poly)
